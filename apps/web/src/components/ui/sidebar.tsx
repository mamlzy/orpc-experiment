  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Handle width based on sidebar state and collapsible mode
        'peer-data-[collapsible=icon]:peer-data-[state=collapsed]:max-w-[calc(100%-var(--sidebar-width-icon))]',
        'peer-data-[collapsible=offcanvas]:peer-data-[state=collapsed]:max-w-full',
        'peer-data-[state=expanded]:max-w-[calc(100%-var(--sidebar-width))]',
        className
      )}
      {...props}
    />
